class Body {
    ...
    overlapsWall(gameMap) {
        return this.overlapWallX(gameMap, 1) || this.overlapWallY(gameMap, 1);
    }

    overlapsMapType(gameMap, mapType) {
        return this.overlapWallX(gameMap, mapType) || this.overlapWallY(gameMap, mapType);
    }

    overlapWallY(gameMap, mapType) {
        return this.overlapWallYPos(this.y0(), gameMap, mapType) ||
            this.overlapWallYPos(this.y1(), gameMap, mapType);
    }

    overlapWallYPos(pos, gameMap, mapType) {
        let overlap = false;
        ...
        if (gameMap[frameMapY][oldMapX] == mapType) {
            overlap = true;
        }
    ...
    overlapWallX(gameMap, mapType) {
        return this.overlapWallXPos(this.x0(), gameMap, mapType) ||
            this.overlapWallXPos(this.x1(), gameMap, mapType);
    }

    overlapWallXPos(pos, gameMap, mapType) {
        let overlap = false;
        ...
        if (gameMap[oldMapY][frameMapX] == mapType) {
            overlap = true;
    ...
    bounceWall(gameMap) {
        ...
        this.y += this.dy;
        if (this.overlapWallY(gameMap, 1)) {
            this.y -= this.dy;
            this.dy *= -1;
        ...
        this.x += this.dx;
        if (this.overlapWallX(gameMap, 1)) {
            this.x -= this.dx;
            this.dx *= -1;
        }
    }
